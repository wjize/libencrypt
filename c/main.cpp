...
int main() {
    ...
    my_aes_encrypt_test = (encrypt_func)dlsym(handle, "gbase_aes_encrypt_test");
    ...
    my_aes_decrypt_test = (decrypt_func)dlsym(handle, "gbase_aes_decrypt_test");
    ...
    my_aes_get_size_test = (get_size_func)dlsym(handle, "gbase_aes_get_size_test");
